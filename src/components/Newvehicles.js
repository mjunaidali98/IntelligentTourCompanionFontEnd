...
const columns = [
    ...
    { title: 'Address', dataIndex: 'address', key: 'address' },
    {
        ...
        dataIndex: 'userid',
        key: 'userid',
        render: () => <a onClick={window.alert('hi')} style={{ color: 'blue' }}>Approve</a>,
    },
    {
        title: 'Action',
        dataIndex: '',
...
export default class Newvehicles extends Component {
    ...
    render() {
        return (
            <div className="canvastransport" id="transportId" style={{ backgroundColor: 'white', overflowY:'scroll' }}>
                <h3 style={{ fontFamily: 'Titillium Web', marginTop: '-100px' }}>Approve Transport</h3>
