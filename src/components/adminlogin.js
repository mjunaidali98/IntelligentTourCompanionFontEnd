    ...
    return (
      <div id="a_Box">
        <div className="login-form">
          <form onSubmit={this.onSubmit} id="a_form">
            ...
            <div className="bottom-action clearfix">
              ...
              <Link data-toggle="modal" data-target="#myModal" className="float-right">
                Forgot Password?
              </Link>
            </div>
            <br />
        ...
        <ToastContainer
          ...
          pauseOnHover
        />
        <div class="modal fade" id="myModal" role="dialog" style={{marginTop:'200px'}}>
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
              <h4 class="modal-title" style={{marginLeft:'20px', color:'red'}}>We will send you a recovery link</h4>
            ...
            " style={{width:'300px' , float:'left'}}
                ...
                required="required"
              />
              <button type="button" class="btn btn-dark" style={{float:'left',width:'80px', marginLeft:'10px'}}>Recieve</button>
              </div>
              </div>
