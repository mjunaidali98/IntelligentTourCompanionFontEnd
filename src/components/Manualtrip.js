...
function getSteps() {
    return ['Where are you going?', 'Route View', 'Select Point of Interest', 'Select Hotels', 'Select Vehicles'];
}
                                        ...
                                        <div className="row">
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="date" id="startdate" style={{ fontSize: '12px' }} onChange={this.startdateChange} value={this.state.startdate} required />
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    <span className="form-label">End date</span>
                                                    <input className="form-control" id="enddate" style={{ fontSize: '12px' }} onChange={this.enddateChange} type="date" value={this.state.enddate} required />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="row">
                                            <div className="col-sm-4">
                                                <div className="form-group">
                                                    ...
                                                    <select onChange={this.typeChange} value={this.state.type} className="form-control">
...
export default function Manualtrip() {
    ...
    Inputdetails = { source: source, destination: destination, startdate: startdate, enddate: enddate, travelFuel: travelFuel, travelDistance: travelDis, travelTime: travelTime, stayCity: 'bahawalpur' }
                ...
                <div>
                    {activeStep === steps.length ? (
                        <div style={{ marginTop: '30px' }}>
                            <Tourgenerator Inputdetails={Inputdetails} />
...
class Manualcheckroute extends Component {
    constructor() {
        ...
        this.state = {
            ...
            travelTime: null,
            fuelUsed: null,
            apiKey: 'VvkNzPWbou9Hy991bTTmJNfcbLGzv9Rs',
            snackbar: false,
            stayCity: null,
        }
    ...
    async stayCityName(e) {
        ...
        console.log('stay city is' + this.state.stayCity)
    ...
    render() {
        ...
        return (
            <div><div id="routeshortDetails" style={{ width: '20%', position: 'absolute', top: '53%', left: '73%', backgroundColor: "#E8E8E8", color: "black" }}>
                ...
                {travelTime >= "10:00:00" ? <><Snackbar open={this.state.snackbar} style={{ position: 'absolute', left: '30%', top: '33%', width: '450px' }} autoHideDuration={6000000} onClose={handleClose}>
